...
public class SolicitudService {
    ...
    private final ContenedorService contenedorService; // <-- 1. Inyéctalo
    private final RestTemplate restTemplate;   // 👈 NUEVO
    ...
    this.restTemplate = restTemplate;   // 👈 guardamos el cliente HTTP
